...
export default function EditModal({ show, handleClose, data, handleSave }) {
  ...
  const handleUpdate = async (values) => {
    ...
    try {
      ...
      await axios.put(`/materials/out/${id}`, formattedValues);
  ...
  return (
    ...
    >
      ...
      <Row className="bg-light border rounded d-flex justify-content-center pt-2">
        ...
        >
          <span className="fs-5">
            <FaRegEdit className="pb-1" /> EDIÇÃO: SAÍDA DE MATERIAL
          </span>
        </Row>
                ...
                <Row>
                  ...
                  >
                    ...
                    <Select
                      ...
                      onBlur={handleBlur}
                      isDisabled={!initialValues.removedBy}
                    />
