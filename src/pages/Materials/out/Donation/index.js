...
export default function Index() {
  ...
  const handleStore = async (values, resetForm) => {
    ...
    formattedValues.materialOuttypeId = 7; // SAÍDA POR DOAÇÃO
  ...
  return (
    <>
      ...
      <Row className="bg-light border rounded d-flex justify-content-center pt-2">
        ...
        >
          <span className="fs-5">SAÍDA DE MATERIAL: DOAÇÃO</span>
        </Row>
                ...
                <Row>
                  <Form.Group xs={12} className="pb-3" controlId="obs">
                    ...
                    <Form.Control
                      ...
                      placeholder="Detalhe a situação: Para quem foi a doação (Vedado pessoa física); Motivo da doação (inservível, obsoleto, incompatível); Etc"
                      onBlur={(e) => {
