  ...
  return (
    <>
      ...
      <Row className="bg-light border rounded d-flex justify-content-center pt-2">
        ...
        >
          <span className="fs-5">SAÍDA DE MATERIAL: DEVOLUÇÃO</span>
        </Row>
                ...
                <Row>
                  ...
                  >
                    ...
                    <Form.Control
                      ...
                      placeholder="Destino da devolução"
                    />
                ...
                <Row>
                  <Form.Group xs={12} className="pb-3" controlId="obs">
                    ...
                    <Form.Control
                      ...
                      placeholder="Detalhe a situação: Para quem foi a devolução: Almoxarifado Central ou Fornecedor; Motivo da devolução; Requisição que gerou entrada; Devolução parcial ou total; Etc"
                      onBlur={(e) => {
